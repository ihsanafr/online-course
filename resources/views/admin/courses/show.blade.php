<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-slate-800 overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-slate-400 text-sm">{{$course->category->name}}</p>
                        </div>
                    </div>
                    <div class="flex flex-col">
                ...
                <div class="flex flex-row justify-between items-center">
                    <div class="flex flex-col">
                        ...
                        <p class="text-slate-400 text-sm">{{$course->course_videos->count()}}</p>
                    </div>
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between items-center"> 
                    <div class="flex flex-row items-center gap-x-3">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-slate-400 text-sm">{{$video->course->name}}</p>
                        </div>
                    </div>

                    
                    <div class="flex flex-row items-center gap-x-3">
                        <a href="{{route('admin.course_videos.edit', $video->id)}}" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            Edit Video
                        </a>
