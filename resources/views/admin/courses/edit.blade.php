            ...
            <div class="bg-gray-800 overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{route('admin.courses.update', $course)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id" class="py-3 rounded-lg pl-3 w-full bg-gray-900 text-white  ">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about" cols="30" rows="5" class=" bg-gray-900 text-white  rounded-xl w-full">{{$course->about}}</textarea>
                    ...
                    <div class="mt-4">
                        <div class="flex flex-col gap-y-5">
                            ...
                            @forelse($course->course_keypoints as $keypoint)
                                <input type="text" class="py-3 rounded-lg bg-gray-900 text-white" value="{{$keypoint->name}}" placeholder="Write your copywriting" name="course_keypoints[]">
                            @empty
                            @endforelse
                        </div>
